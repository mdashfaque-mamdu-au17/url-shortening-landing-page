  ...
  return (
    <div className="bg-white rounded-[5px] lg:pl-8 lg:pr-6 lg:py-[18px]">
      <div className="lg:flex lg:items-center lg:justify-between">
        <div>
          <p className="text-base font-medium text-primary-black leading-9 py-[6px] px-4 lg:py-0 lg:px-0 lg:text-xl">
            https://www.frontendmentor.io
          </p>
          <div className="h-[1px] bg-dark-gray opacity-25 lg:hidden"></div>
        </div>
        <div className="lg:flex lg:items-center lg:gap-6">
          <p className="text-base font-medium leading-9 tracking-[0.12px] text-dark-cyan pt-[6px] pb-2 px-4 lg:pt-0 lg:pb-0 lg:px-0 lg:text-xl">
